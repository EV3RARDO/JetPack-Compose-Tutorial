...
import com.example.myapplication.ui.restaurantsDemo.RestaurantDetails
import com.example.myapplication.ui.restaurantsDemo.RestaurantIcon

@Composable
fun RestaurantDetailsScreen(viewModel: RestaurantDetailsViewModel = hiltViewModel()) {

    val item = viewModel.state.value.restaurant
